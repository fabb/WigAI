...
-   **[Epic 1: Core Extension Setup, MCP Server Initialization, and Basic Transport Control](./epic-1.md)**
    * **Goal:** Establish the foundational Bitwig Java extension, implement the basic MCP server listener, and enable start/stop transport control via MCP commands.
-   **[Epic 2: Device Parameter Read and Write Implementation](./epic-2.md)**
...
-   **[Epic 3: Clip and Scene Launching Implementation](./epic-3.md)**
    * **Goal:** Enable the triggering of individual clips (by track name and clip index/scene number) and entire scenes (by name or index) via MCP commands, expanding interactive control.
-   **[Epic 4: Extension UI Settings Integration](./epic-4.md)**
    * **Goal:** Replace the hardcoded ConfigManager with Bitwig Studio's Preferences API integration, providing users with a GUI for configuring MCP server settings and displaying connection information.
-   **[Epic 5: Enhance MCP `status` Command](./epic-5.md)**
    * **Goal:** Significantly enhance the `status` MCP command by providing a more comprehensive snapshot of the current Bitwig Studio state, enabling more informed AI agent decisions.
-   **[Epic 6: Track Information Retrieval](./epic-6.md)**
    * **Goal:** Provide comprehensive MCP tools for listing all tracks and retrieving detailed information about specific tracks, including the currently selected track.
-   **[Epic 7: Scene and Clip Information Retrieval](./epic-7.md)**
    * **Goal:** Provide MCP tools for listing all scenes and retrieving detailed clip information within a specific scene across all tracks.
-   **[Epic 8: Device Information Retrieval](./epic-8.md)**
    * **Goal:** Provide MCP tools to list devices on a specific track and retrieve detailed information including remote controls and remote control pages for a specific device.
