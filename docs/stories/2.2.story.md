...
- Tool name: `set_selected_device_parameter` (matches `docs/api-reference.md#device_setParameter`)
...
- `docs/api-reference.md#device_setParameter` - MCP command specification
