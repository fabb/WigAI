...
This API adheres to the official MCP specification (2025-03-26), utilizing the SSE transport (Streamable HTTP planned) and implementing the tools interface. All requests and responses are JSON-RPC 2.0 formatted. WigAI implements this specification using the official MCP Java SDK (version 0.9.0+), leveraging the SDK's tool-based architecture pattern for registering, validating, and handling MCP requests.
...
| SDK reference update        | 2025-05-18 | 0.2.2   | Added explicit reference to MCP Java SDK version 0.9.0+ and tool-based architecture pattern. | GitHub Copilot    |