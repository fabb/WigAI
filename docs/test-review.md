...
**Severity**: P1 (High)
**Location**: `src/test/java/io/github/fabb/wigai/smoke/McpSmokeHarnessAtddTest.java:17`
**Criterion**: Test IDs
...
**Severity**: P1 (High)
**Location**: `src/test/java/io/github/fabb/wigai/smoke/McpSmokeHarnessAtddTest.java:14`
...
**Severity**: P2 (Medium)
**Location**: `src/test/java/io/github/fabb/wigai/smoke/McpSmokeHarnessAtddTest.java:18`
...
**Location**: `src/test/java/io/github/fabb/wigai/smoke/McpSmokeHarnessAtddTest.java:167`
...
**Location**: `src/test/java/io/github/fabb/wigai/smoke/McpSmokeHarnessAtddTest.java:80`
...
**Review ID**: test-review-McpSmokeHarnessAtddTest-20251223
